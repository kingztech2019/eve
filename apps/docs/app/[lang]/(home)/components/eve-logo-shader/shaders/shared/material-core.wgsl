...
export fn env_reflection_from_dir(
  ...
  coloredEnvCube: texture_2d_array<f32>,
  envSampler: sampler,
  reflected: vec3f,
  envYaw: f32,
  envColorMix: f32,
) -> vec3f {
  return sample_env(envCube, coloredEnvCube, envSampler, reflected, envYaw, envColorMix);
}
...
export fn env_reflection(
  ...
  return env_reflection_from_dir(envCube, coloredEnvCube, envSampler, env_reflect_dir(n, v), envYaw, envColorMix);
}
